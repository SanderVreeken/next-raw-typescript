const products = [{
    ...
    href: '/services/revenue-management-consulting',
    items: ['Revenue performance analysis on relevant KPI’s', 'Segmentation', 'Distribution strategy', 'Competitive analysis', 'Demand Calendar', 'Benchmarking', 'Reputation Management', 'Systems'],
    ...
    href: '/services/interim-revenue-management',
    ...
    href: '/services/outsourced-revenue-management',
